...
```
cd existing_repo
git remote add origin https://gitlab.com/charlzzprojects/energy-iso.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/charlzzprojects/energy-iso/-/settings/integrations)
